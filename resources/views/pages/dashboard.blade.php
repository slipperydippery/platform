    ...
    <div class="row">
    	...
    	<div class="col-md-3">
    		<a href=" {{ route('introductiefilm') }} " title="">
    		    <div class="card card__dashboard mt-4">
    		        <div class="card-body">
            ...
            <div class="card card__dashboard mt-4" data-toggle="tooltip" data-placement="top" title="De kennisbank is nog in ontwikkeling">
                <div class="card-body">
