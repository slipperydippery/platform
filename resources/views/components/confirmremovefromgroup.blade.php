    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="confirmdeleteLabel">Weet je zeker dat je {{ $thisscan->user->name }} uit de groep wilt verwijderen? </h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <p>Je staat op het punt om {{ $thisscan->user->name }} uit de groepssessie te verwijderen. Weet je zeker dat je dit wilt doen? </p>
                ...
                <div class="modal-footer">
                    ...
                    <form action="{{ route('scan.destroy' , $thisscan)}}" method="POST">
                        ...
                        <button type="submit" class="btn btn-danger">Verwijder uit de sessie</button>
                    </form>
                </div>
            </div>
        </div>
