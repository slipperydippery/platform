<div class="modal fade" id="sendmessage_{{ $recipient->id }}_{{ $group->id }}" tabindex="-1" role="dialog" aria-labelledby="sendmessageLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="sendmessageLabel"> Verstuur bericht aan {{ $user->name }}  </h5>
