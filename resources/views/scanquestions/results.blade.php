		...
		<div class="row">
	        ...
	        <div class="col d-flex">
	            <div class="flex-grow-1">
                    <p>Dit zijn de scores van de deelnemers. Bespreek met elkaar wat er uit springt en/of over welke onderwerpen sterk van mening wordt verschild. In het volgende scherm kunnen aantekeningen worden gemaakt om de belangrijkste twee of drie verbeterpunten later uit te werken.</p>
	            </div>
	            <div class="">
